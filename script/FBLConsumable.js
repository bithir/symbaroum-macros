...
consumables.forEach(t => {
    allConsumables = allConsumables.concat(`<label for="${t}">${game.i18n.localize("CONSUMABLE."+t.toUpperCase())}</label> <input id='${t}' type="checkbox" ${defaultCheck}="${defaultCheck}" name="consumable" value="${t}"><br/>`);
});
